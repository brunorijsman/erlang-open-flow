...
-define(OF_V10_MESSAGE_TYPE_MAX,                      23).
...
-define(OF_V10_MESSAGE_TYPE_EXPERIMENTER,             4).
...
-define(OF_V10_MESSAGE_TYPE_GROUP_MOD,                15).
-define(OF_V10_MESSAGE_TYPE_PORT_MOD,                 16).
-define(OF_V10_MESSAGE_TYPE_TABLE_MOD,                17).
-define(OF_V10_MESSAGE_TYPE_STATS_REQUEST,            18).
-define(OF_V10_MESSAGE_TYPE_STATS_REPLY,              19).
-define(OF_V10_MESSAGE_TYPE_BARRIER_REQUEST,          20).
-define(OF_V10_MESSAGE_TYPE_BARRIER_REPLY,            21).
-define(OF_V10_MESSAGE_TYPE_QUEUE_GET_CONFIG_REQUEST, 22).
-define(OF_V10_MESSAGE_TYPE_QUEUE_GET_CONFIG_REPLY,   23).

%% Error types
-define(OF_V10_ERROR_TYPE_HELLO_FAILED,         0).
-define(OF_V10_ERROR_TYPE_BAD_REQUEST,          1).
-define(OF_V10_ERROR_TYPE_BAD_ACTION,           2).
-define(OF_V10_ERROR_TYPE_BAD_INSTRUCTION,      3).
-define(OF_V10_ERROR_TYPE_BAD_MATCH,            4).
-define(OF_V10_ERROR_TYPE_FLOW_MOD_FAILED,      5).
-define(OF_V10_ERROR_TYPE_GROUP_MOD_FAILED,     6).
-define(OF_V10_ERROR_TYPE_PORT_MOD_FAILED,      7).
-define(OF_V10_ERROR_TYPE_TABLE_MOD_FAILED,     8).
-define(OF_V10_ERROR_TYPE_QUEUE_OP_FAILED,      9).
-define(OF_V10_ERROR_TYPE_SWITCH_CONFIG_FAILED, 10).

%% Error codes
-define(OF_V10_ERROR_CODE_MIN, 0).
-define(OF_V10_ERROR_CODE_MAX, 12).
...
-define(OF_V10_ERROR_CODE_BAD_REQUEST_BAD_EXPERIMENTER, 3).
...
-define(OF_V10_ERROR_CODE_BAD_REQUEST_BAD_TABLE_ID,     9).

-define(OF_V10_ERROR_CODE_BAD_ACTION_BAD_TYPE,              0).
-define(OF_V10_ERROR_CODE_BAD_ACTION_BAD_LEN,               1).
-define(OF_V10_ERROR_CODE_BAD_ACTION_BAD_EXPERIMENTER,      2).
-define(OF_V10_ERROR_CODE_BAD_ACTION_BAD_EXPERIMENTER_TYPE, 3).
...
-define(OF_V10_ERROR_CODE_BAD_ACTION_BAD_OUT_GROUP,         9).
-define(OF_V10_ERROR_CODE_BAD_ACTION_MATCH_INCONSISTENT,    10).
-define(OF_V10_ERROR_CODE_BAD_ACTION_UNSUPPORTED_ORDER,     11).
-define(OF_V10_ERROR_CODE_BAD_ACTION_BAD_TAG,               12).

-define(OF_V10_ERROR_CODE_BAD_INSTRUCTION_UNKNOWN_INST,        0).
-define(OF_V10_ERROR_CODE_BAD_INSTRUCTION_UNSUP_INST,          1).
-define(OF_V10_ERROR_CODE_BAD_INSTRUCTION_BAD_TABLE_ID,        2).
-define(OF_V10_ERROR_CODE_BAD_INSTRUCTION_UNSUP_METADATA,      3).
-define(OF_V10_ERROR_CODE_BAD_INSTRUCTION_UNSUP_METADATA_MASK, 4).
-define(OF_V10_ERROR_CODE_BAD_INSTRUCTION_UNSUP_EXP_INST,      5).

-define(OF_V10_ERROR_CODE_BAD_MATCH_BAD_TYPE,         0).
-define(OF_V10_ERROR_CODE_BAD_MATCH_BAD_LEN,          1).
-define(OF_V10_ERROR_CODE_BAD_MATCH_BAD_TAG,          2).
-define(OF_V10_ERROR_CODE_BAD_MATCH_BAD_DL_ADDR_MASK, 3).
-define(OF_V10_ERROR_CODE_BAD_MATCH_BAD_NW_ADDR_MASK, 4).
-define(OF_V10_ERROR_CODE_BAD_MATCH_BAD_WILDCARDS,    5).
-define(OF_V10_ERROR_CODE_BAD_MATCH_BAD_FIELD,        6).
-define(OF_V10_ERROR_CODE_BAD_MATCH_BAD_VALUE,        7).

-define(OF_V10_ERROR_CODE_FLOW_MOD_FAILED_UNKNOWN,      0).
-define(OF_V10_ERROR_CODE_FLOW_MOD_FAILED_TABLE_FULL,   1).
-define(OF_V10_ERROR_CODE_FLOW_MOD_FAILED_BAD_TABLE_ID, 2).
-define(OF_V10_ERROR_CODE_FLOW_MOD_FAILED_OVERLAP,      3).
-define(OF_V10_ERROR_CODE_FLOW_MOD_FAILED_EPERM,        4).
-define(OF_V10_ERROR_CODE_FLOW_MOD_FAILED_BAD_TIMEOUT,  5).
-define(OF_V10_ERROR_CODE_FLOW_MOD_FAILED_BAD_COMMAND,  6).

-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_GROUP_EXISTS,         0).
-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_INVALID_GROUP,        1).
-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_WEIGHT_UNSUPPORTED,   2).
-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_OUT_OF_V10_GROUPS,    3).
-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_OUT_OF_V10_BUCKETS,   4).
-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_CHAINING_UNSUPPORTED, 5).
-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_WATCH_UNSUPPORTED,    6).
-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_LOOP,                 7).
-define(OF_V10_ERROR_CODE_GROUP_MOD_FAILED_UNKNOWN_GROUP,        8).

-define(OF_V10_ERROR_CODE_PORT_MOD_FAILED_BAD_PORT,      0).
-define(OF_V10_ERROR_CODE_PORT_MOD_FAILED_BAD_HW_ADDR,   1).
-define(OF_V10_ERROR_CODE_PORT_MOD_FAILED_BAD_CONFIG,    2).
-define(OF_V10_ERROR_CODE_PORT_MOD_FAILED_BAD_ADVERTISE, 3).

-define(OF_V10_ERROR_CODE_TABLE_MOD_FAILED_BAD_TABLE,  0).
-define(OF_V10_ERROR_CODE_TABLE_MOD_FAILED_BAD_CONFIG, 1).
...
-define(OF_V10_ERROR_CODE_SWITCH_CONFIG_FAILED_BAD_FLAGS, 0).
-define(OF_V10_ERROR_CODE_SWITCH_CONFIG_FAILED_BAD_LEN,   1).

%% Port numbers
-define(OF_V10_PORT_NO_MAX,        0xffffff00).
-define(OF_V10_PORT_NO_IN,         0xfffffff8).
-define(OF_V10_PORT_NO_TABLE,      0xfffffff9).
-define(OF_V10_PORT_NO_NORMAL,     0xfffffffa).
-define(OF_V10_PORT_NO_FLOOD,      0xfffffffb).
-define(OF_V10_PORT_NO_ALL,        0xfffffffc).
-define(OF_V10_PORT_NO_CONTROLLER, 0xfffffffd).
-define(OF_V10_PORT_NO_LOCAL,      0xfffffffe).
-define(OF_V10_PORT_NO_ANY,        0xffffffff).
...
-type of_version() :: ?OF_V10_VERSION_2.

-type of_message_type() :: ?OF_V10_MESSAGE_TYPE_HELLO..?OF_V10_MESSAGE_TYPE_QUEUE_GET_CONFIG_REPLY.

-type of_error_type() :: ?OF_V10_MESSAGE_TYPE_HELLO..?OF_V10_MESSAGE_TYPE_QUEUE_GET_CONFIG_REPLY.

-type of_error_code() :: ?OF_V10_ERROR_CODE_MIN..?OF_V10_ERROR_CODE_MAX.
